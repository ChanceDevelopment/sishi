...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.usercarPass = [[self objectOrNilForKey:kUserFollowListModelUsercarPass fromDictionary:dict] doubleValue];
            ...
            self.userPass = [[self objectOrNilForKey:kUserFollowListModelUserPass fromDictionary:dict] doubleValue];
