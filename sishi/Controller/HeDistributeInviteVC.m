...
@interface HeDistributeInviteVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)initView
{
    ...
    distributeItem.title = @"发表";
    distributeItem.tintColor = [UIColor blackColor];
    distributeItem.target = self;
    distributeItem.action = @selector(distributeButtonClick:);
...
- (void)distributeButtonClick:(UIBarButtonItem *)item
{
