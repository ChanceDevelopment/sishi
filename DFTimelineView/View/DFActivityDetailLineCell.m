...
@interface DFActivityDetailLineCell()
...
@implementation DFActivityDetailLineCell
...
-(void) initCell
{
    ...
    if (_textContentLabel == nil) {
        ...
        __weak DFActivityDetailLineCell *weakSelf = self;
...
//        _collectionActivityLabel.layer.borderWidth = 0.5;
//        _collectionActivityLabel.layer.borderColor = [UIColor grayColor].CGColor;
...
//        UIImageView *collectionIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"collection_default"]];
//        collectionIcon.highlightedImage = [UIImage imageNamed:@"collection_disable"];
//        collectionIcon.frame = CGRectZero;
//        collectionIcon.tag = -1;
//        collectionIcon.highlighted = NO;
//        [_collectionActivityLabel addSubview:collectionIcon];
        
//        [_collectionActivityLabel setDidClickLinkBlock:^(MLLink *link, NSString *linkText, MLLinkLabel *label) {
//            NSString *tips = [NSString stringWithFormat:@"Click\nlinkType:%ld\nlinkText:%@\nlinkValue:%@",(unsigned long)link.linkType,linkText,link.linkValue];
//            NSLog(@"%@", tips);
//        }];
...
//        _joinActivityLabel.layer.borderWidth = 0.5;
//        _joinActivityLabel.layer.borderColor = [UIColor grayColor].CGColor;
...
//        UIImageView *joinIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"attend_default"]];
//        joinIcon.highlightedImage = [UIImage imageNamed:@"attend_disable"];
//        joinIcon.frame = CGRectZero;
//        joinIcon.tag = -1;
//        joinIcon.highlighted = YES;
//        [_joinActivityLabel addSubview:joinIcon];
...
-(void)updateWithItem:(DFActivityDetailLineItem *)item
{
    ...
    //参加
    NSInteger joinNum = [item.joins count];
    if (joinNum == 0) {
    ...
    //参加人详情的视图区域
    CGFloat joinHeight = [DFLikeJoinView getHeight:item maxWidth:BodyMaxWidth];
